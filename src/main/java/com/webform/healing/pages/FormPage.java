...
public class FormPage {
    ...
    private By ddlProvince = By.id("province");
    private By ddlCity = By.id("city");
    ...
    public FormPage selectProvince(String province) {
        new Select(driver.findElement(ddlProvince)).selectByVisibleText(province);
        return this;
    }

    public FormPage selectCity(String city) {
        new Select(driver.findElement(ddlCity)).selectByVisibleText(city);
        return this;
    }
